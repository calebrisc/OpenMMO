 ...
 *
 * Only the plain level trigger is here, which is 134 of the 184 the games define. The rest wait on
 * things this server has no notion of yet: beauty, friendship, friendship_day, friendship_night,
 * item, level_atk_eq_def, level_atk_gt_def, level_atk_lt_def, level_cascoon, level_ninjask,
 * level_shedinja, level_silcoon, trade, trade_item. Leaving them out means a monster that should
 * evolve by stone simply does not, rather than evolving at the wrong moment.
 */
